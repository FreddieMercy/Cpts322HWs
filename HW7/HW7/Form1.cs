...
namespace HW7
{
    public partial class Form1 : Form
    {
        ...
        {
            //Once again: Cpts 322 HW 7 by Junhao Zhang"Freddie" ID#: 11356533
        }

        private void button1_Click(object sender, EventArgs e)
        {
            sheet.GetCell(10, 10).Color = Color.Red.ToArgb();
        }


        private void browseFromComputerToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        private void changeTheCellBackgroundColorToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Color theColor = new Color();
