...
namespace SpreadSheetEngine
{
        ...
        public virtual string Text
        {
            ...
            set
            {
                ...
                if ((value != null) && (value != "") && (value[0].ToString() == "="))
                {
                    ...
                    {
                        ThePropertyChanged(this, new PropertyChangedEventArgs(this.RowIndex.ToString() + this.ColumnIndex.ToString()));
                    }
    ...
    public class Cell : SpreadCell
    {
        ...
        // make derived class use base class event
        protected override void ThePropertyChanged(object sender, PropertyChangedEventArgs e)
        {
            base.ThePropertyChanged(sender, e);
        }
        ...
        public void TextChain(object sender, PropertyChangedEventArgs e)
        {
            ...
            if (e.PropertyName == this.RowIndexs.ToString() + this.ColuIndexs.ToString())
            {
                this.restore();
                return;
            }
